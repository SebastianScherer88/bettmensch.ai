...
def decoder_mask_sa(src_mask):
    ...
    """
    src_length = src_mask.size(-1)
    dec_mask = padded_mask(src_mask)  # (n_batch, 1, src_length)
    dec_mask_sa = dec_mask & subsequent_mask(src_length).type_as(
        dec_mask.data
