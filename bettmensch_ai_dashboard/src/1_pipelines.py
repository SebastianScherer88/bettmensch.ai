...
from dag import DagLayoutSetting
...
def display_pipeline_dag_selection(formatted_pipeline_data, selected_pipeline, dag_visualization_element, tab_container_height: int=600):
    """Generates a tabbed, in depth view of the user selected DAG task node element.

    Args:
        formatted_pipeline_data (_type_): The formatted pipeline data as generated by `get_formatted_pipeline_data`
        selected_pipeline (_type_): The user selected pipeline name.
